...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($USUARIO) > 20 || !ctype_alnum($USUARIO)) {
        $error_message = "El usuario debe tener un máximo de 20 caracteres alfanuméricos.";
    } elseif (strlen($PASSWORD) > 11 || !ctype_digit($PASSWORD)) {
        $error_message = "La contraseña debe tener un máximo de 11 números.";
    } else {
...
<div class="wrapper">
        <form action="index.php" method="POST">
            ...
            <div class="input-box">
                <input type="password" name="CONTRASENA" placeholder="Contraseña" maxlength="11" pattern="\d{1,11}" required>
